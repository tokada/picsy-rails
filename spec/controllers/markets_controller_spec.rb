  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested market" do
        ...
        Market.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => market.to_param, :market => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the market as @market" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Market.any_instance.stub(:save).and_return(false)
        put :update, {:id => market.to_param, :market => { "name" => "invalid value" }}, valid_session
        assigns(:market).should eq(market)
      end
