...
(function() {
  ...
  $("td.ev").each(function(d) {
    ...
    return $(this).data("r", RegExp.$1).data("c", RegExp.$2).click(function() {
      if ($(this).data("c") > 0 && $(this).data("c") !== $(this).data("r")) {
        ...
        if (saved.cell[0] === $(this).data("r") && saved.cell[1] === $(this).data("c")) {
          ...
          return $("#amount").val(~~(parseFloat($("#self-p" + saved.cell[0]).text()) / 10));
        }
      }
    }).hover((function() {
      if ($(this).data("c") > 0 && $(this).data("c") !== $(this).data("r")) {
        ...
        return $("#to-p" + $(this).data("c")).addClass("btn-success");
      }
    }), function() {
      if ($(this).data("c") > 0 && $(this).data("c") !== $(this).data("r")) {
        if (saved.cell[0] !== $(this).data("r") || saved.cell[1] !== $(this).data("c")) {
        ...
        if (saved.cell[1] !== $(this).data("c")) {
          return $("#to-p" + $(this).data("c")).removeClass("btn-success");
        }
      }
    });
  });

  get_person = function(person_id, timeout) {
    var element1, element2;

    element1 = $("#from-p" + person_id + " .rest-in-place");
    element2 = $("#to-p" + person_id + " .rest-in-place");
    if (element1.data("url-partial") !== void 0) {
  ...
  $('.rest-in-place-person').bind('activate.rest-in-place', function(event) {
    return $(this).text($(this).data("name"));
  });

  $('.rest-in-place-person').bind('abort.rest-in-place', function(event) {
    if ($(this).find("input").val().match("^@")) {
      return get_person($(this).data("id"), 1);
    }
  });

  $('.rest-in-place-person').bind('success.rest-in-place', function(event, data) {
    var person_id;

    person_id = $(this).data("id");
    get_person(person_id, 1);
    $("option#person-from-p" + person_id).html(data.name);
    return $("option#person-to-p" + person_id).html(data.name);
  });

  $(function() {
    return $("a[data-select-theme]").click(function() {
      var theme, theme_enabled;
