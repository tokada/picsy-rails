...
class TradesControllerTest < ActionController::TestCase
  ...
  test "should create trade" do
    assert_difference('Trade.count') do
      post :create, trade: { amount: @trade.amount, buyable_id: @trade.buyable_id, item_id: @trade.item_id, sellable_id: @trade.sellable_id }
    end
  ...
  test "should update trade" do
    patch :update, id: @trade, trade: { amount: @trade.amount, buyable_id: @trade.buyable_id, item_id: @trade.item_id, sellable_id: @trade.sellable_id }
    assert_redirected_to trade_path(assigns(:trade))
  end
