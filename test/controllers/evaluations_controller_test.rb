...
class EvaluationsControllerTest < ActionController::TestCase
  ...
  test "should create evaluation" do
    assert_difference('Evaluation.count') do
      post :create, evaluation: { amount: @evaluation.amount, buyable_id: @evaluation.buyable_id, sellable_id: @evaluation.sellable_id }
    end
  ...
  test "should update evaluation" do
    patch :update, id: @evaluation, evaluation: { amount: @evaluation.amount, buyable_id: @evaluation.buyable_id, sellable_id: @evaluation.sellable_id }
    assert_redirected_to evaluation_path(assigns(:evaluation))
  end
